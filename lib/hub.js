...
module.exports = function(options) {
  ...
  app.use(route.post('/api/v1/messages', function*() {
    ...
    msg.maxAttempts = msg.maxAttempts || config.msgDefaults.maxAttempts
    msg.attemptDelays = msg.attemptDelays || config.msgDefaults.attemptDelays
    msg.attemptsMade = msg.attemptsMade || 0
    msg.env = msg.env || config.msgDefaults.env
  ...
  function *startServices() {
    _hub.repo = new ServicesRepository(
      options.manifest || options.manifestUrl,
      options
    )

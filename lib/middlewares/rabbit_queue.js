...
class RabbitQueue extends Transport {
  ...
  *enqueue(msg) {
    ...
    var bufferFull = !this.channel.publish('', this.queueName, new Buffer(JSON.stringify(msg)))
  ...
  *publish(msg) {
    ...
    var bufferFull = !this.channel.publish(msg.messageType, '', new Buffer(JSON.stringify(msg)))
    if (bufferFull) this.reportMissedMessage(msg)
  }

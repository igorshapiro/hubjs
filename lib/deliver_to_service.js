...
module.exports = function(svc) {
  ...
  function *handleError(msg, err) {
    ...
    if (msg.attemptsMade >= msg.maxAttempts) {
      yield svc.kill(msg)
      return stats.increment(['hub.messages.killed', "hub." + svc.name + ".messages.killed"])
    }

    var delay = msg.attemptDelays[msg.attemptsMade - 1] || msg.attemptDelays[msg.attemptDelays.length - 1]
    yield svc.schedule(msg, delay.after())
